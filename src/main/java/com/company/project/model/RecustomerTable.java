...
@Table(name = "recustomer_table")
public class RecustomerTable {
    /**
     * 编号
     */
    @Id
     ...
     * 回收工单号
     */
    @Column(name = "reback_wf_id")
    private String rebackWfId;
     ...
     * 获取回收工单号
     *
     * @return reback_wf_id - 回收工单号
     */
    public String getRebackWfId() {
        return rebackWfId;
    }
     ...
     * 设置回收工单号
     *
     * @param rebackWfId 回收工单号
     */
    public void setRebackWfId(String rebackWfId) {
        this.rebackWfId = rebackWfId;
    }
