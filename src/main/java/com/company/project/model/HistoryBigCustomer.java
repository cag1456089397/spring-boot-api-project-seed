...
@Table(name = "history_big_customer")
public class HistoryBigCustomer {
    @Id
     ...
     * 号码资源/IP资源 
     */
    @Column(name = "number_or_ip_resource")
     ...
     * 获取号码资源/IP资源 
     *
     * @return number_or_ip_resource - 号码资源/IP资源 
     */
